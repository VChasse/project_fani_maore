...
st.sidebar.latex(
    r"\text{vulnerabilityIndexRaw} = \left( \text{pctEarth} \times 3 + \text{pctConcrete} \times 2 + \text{pctTile} \times 1 \right) \times \log(\text{Population}) \times \text{residentsPerDwelling}"
)
